...
namespace ClientWPF
{
    ...
    internal class ViewModelUnits : BaseViewModel
    {
        object type1;
        public ObservableCollection<Units> Coll
        {
            get
            {

                ObservableCollection<Units> obj = this.coll.obj;
                return obj;
        ...
        Collection<Units> coll = new Collection<Units>();
        ...
        public ViewModelUnits(string host)
        {
            type = host;
